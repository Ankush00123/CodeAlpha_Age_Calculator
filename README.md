...
#Tools
HTML: used for structing of the webpage and form elements
CSS: used for applying visually appealing and responsive design
JavaScript: Handles the logic to calculate age using the entered date and handles the clear functionality
________________________________________________________________________________________________________________
#How to Use
